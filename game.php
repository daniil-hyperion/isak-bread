<?
	...
	$file = file_get_contents('levels.json');
...
<head>
	...
	<title>
		<?= getContent("game_title"); ?>
	</title>

	<?php include_once getUrl('inc/link.php'); ?>
	<link rel="stylesheet" href="<?=getUrl('css/style_game.css');?>">
...
<body>
	...
	<?php include_once getUrl('inc/header.game.php'); ?>

	<!-- Если это убрать, то игра падает -->
	<div id="hud">
		<div id="quest">
			<h4 class="title"></h4>
			<h4></h4>
	...
	<div class="alternativa-preloader">
		<img id="alternativa" src="<?= getUrl('img/game/'. getContent('img_preloader_game')); ?>" alt="">
	</div>
	...
	let dataLevel = localStorage.getItem('thisLevel')
	...
	<script src="<?=getUrl('js/script_game.js')?>"></script>
</body>
